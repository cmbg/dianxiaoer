		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '				</div>';
		            html += '			</div>';
					html += '			<div id="preview" style="position:relative; left:2px; top:2px; width:880px"  class="upload_preview"></div>';
					html += '		</div>';
		            ...
		            html += '				<div class="btns">';
		            html += '					<input id="fileImage" type="file" size="30" name="fileselect[]" '+multiple+'>';
		            html += '					<input type="hidden" id="it" name="_token" value="{{csrf_token()}}">'
		            html += '					<div class="webuploader_pick">选择文件</div>';
		            html += '					<div class="upload_btn">开始上传</div>';
		            html += '				</div>';
		            html += '			</div>';
		            html += '			<div id="preview" style="position:relative; left:2px; top:2px; width:880px"  class="upload_preview">';
