...
Route::get('/errors/auth', 'Admin\AuthController@auth');
...
Route::post('/home/sfshop/imgfile', 'Home\SfshopController@imgfile');
Route::get('/home/sfshop/goods/{id}', 'Home\SfshopController@goods');//收到鱼塘id后进入鱼塘商品页
Route::get('/home/sfshop/ajax', 'Home\SfshopController@ajax');//ajax内部接收鱼塘id,请求鱼塘的商品,展示到鱼塘商品页
...
Route::post('admin/homeupload','Admin\HomeUserController@upload');
