            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">权限管理,在这里你可以编辑修改.</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="/admin/permission/{{$data->id}}" method="post" role="form" enctype="multipart/form-data">
                        @if (count($errors) > 0)
                        ...
                        {{method_field('put')}}
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" class="form-control" id="exampleInputPhone1" value="{{$data->description}}"
                                           placeholder="">
                                </div>
                            </div>
                        <!-- /.box-body -->
