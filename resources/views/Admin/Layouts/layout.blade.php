...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>{{config('app.name')}}</b>{{ config('app.version') }}</span>
        </a>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>商品管理 </span>
                        <span class="pull-right-container">
              <span class="label label-pimary pull-right">4</span>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('Admin/Goods?type=1')}}"><i class="fa fa-circle-o"></i>后台商品</a></li>
                        <li><a href="{{url('Admin/Goods?type=0')}}"><i class="fa fa-circle-o"></i> 鱼塘商品</a></li>
                    </ul>
                </li>
                <li>
