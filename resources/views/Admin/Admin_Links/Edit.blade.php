            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">友情链接管理,在这里你可以编辑修改.</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="/admin/links/{{$data->lid}}" method="post" role="form" enctype="multipart/form-data">
                        @if (count($errors) > 0)
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="lname" class="form-control" id="exampleInputName1" value="{{$data->lname}}"
                                       placeholder="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" size="100" id="art_thumb" name="art_thumb" readonly value="{{$data->limg}}">
                                <input id="file_upload" name="limg" type="file">
                                <br>
                                <img src="{{$data->limg}}" id="img1" alt="" style="width:80px;height:80px">
                            </div>
                        </div>
                        <!-- /.box-body -->
