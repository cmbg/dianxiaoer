                                                        ...
                                                        <div class="box-body">
                                                                ...
                                                                <form action="{{url('/Admin/Goods')}}" method="get">
                                                                    <div class="col-sm-3">
                                                                        <div class="dataTables_length"
                                                                             id="example1_length"><label> 查看 <select
                                                                                        name="num"
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <div id="example1_filter"
                                                                             class="dataTables_filter"><label>查找 :
                                                                                <input
                                                                    ...
                                                                    <button class="col-sm-2 bt btn  btn-warning  ">查找
                                                                    </button>
                                                                </form>
                                                            </div>
                                                            <div class="row" style="margin-left: 5px;">
                                                                ...
                                                                <table id="example1"
                                                                       ...
                                                                       style="width: 950px; margin-left: 10px">
                                                                    <thead>
                                                                    <tr role="row">
                                                                    ...
                                                                    @foreach($data as $v)
                                                                        <tr>
                                                                            ...
                                                                            <td rowspan="1"><div style="width:100px;overflow: hidden;">{{$v ->goodsDes}}</div></td>
                                                                            <td rowspan="1"
                                                                            ...
                                                                            <td rowspan="1" colspan="1">
                                                                                <button type="button"
                                                                                    ...
                                                                                    <font
                                                                                            ...
                                                                                            @if($v->gstatus == 2)
                                                                                                下架 @elseif($v->gstatus == 1)
                                                                                                上架 @elseif($v->gstatus == 0)
                                                                                                新品 @endif
                                                                                        </font></font>
                                                                                </button>
                                                                            </td>
