    ...
    @section('content')
        ...
        <div style="width:1200px;height:1000px; margin: 0px auto;">
            ...
            <li id="item" style="display: none;">
                <form method="post">
                    {{csrf_field()}}
                    <input type="hidden" class="ggname" name="gname">
                    <input type="hidden" class="gprice" name="price">
                ...
                <div><span><button type="submit"  class="btn btn-block btn-warning btn-sm"><font
...
//                    console.log(vH);
                    ...
                    sH = sH + 2;
//                    console.log(sH);
                    var dH = $(document).height();//刚开始文档的高度大
//                    console.log(dH);
                    if (vH + sH >= dH) {
                        ajax(p);
                        p++;
...
//                                console.log(data.data[i].fishpond.fishpondname);
                                ...
                                newItem.find('form').attr('action','{{url('home/addcart')}}'+'/'+data.data[i].gid);
                                newItem.find('.ggname').attr('value',data.data[i].gname);
                                newItem.find('.gprice').attr('value',data.data[i].price);
