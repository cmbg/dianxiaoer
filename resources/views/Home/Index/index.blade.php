                                                                    ...
                                                                    <div class="resmenu-container">
                                                                        ...
                                                                        <ul id="menu-vertical-menu-1" class="nav vertical-megamenu etrostore-mega etrostore-menures">
                                                                            ...
                                                                            <li class="fix-menu dropdown menu-smartphones-tablet etrostore-mega-menu level1">
                                                                                <a  href="javascript:;" class="item-link dropdown-toggle">
                                                                                ...
                                                                                <ul class="dropdown-menu nav-level1 column-3">
                                                                                    @foreach($brr[$v->cate_id] as  $m=>$n)
                                                                                        ...
                                                                                        <ul style="height: 225px" class="dropdown-sub nav-level2">
                                                                                            <li style="position: relative" class="menu-laptop-desktop-accessories">
                                                                                                {{--$brr[$v->cate_id][$k]['good']['gid']--}}
                                                                                                <a href="@if(!empty($n->good)){{url('home/goods/list').'/'.$n->cate_id}}@endif">
