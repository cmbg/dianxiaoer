                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="simple_product.html">
                                                    <img width="200" height="100" src="{{$cart->options['pic']}}" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" >
                                                </a>
                                            </td>
                                            ...
                                            <td class="product-remove">
                                                <a href="{{url('home/removecart/'.$cart->rowId)}}" class="remove" title="删除商品"><i class="fa fa-times" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    <tr>
