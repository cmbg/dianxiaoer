                                        ...
                                        <div class="col-2">
                                            <div class="woocommerce-shipping-fields">
                                                ...
                                                <p class="form-row form-row notes" id="order_comments_field">
                                                    ...
                                                    <textarea name="order_comments" class="input-text " id="order_comments" placeholder="对商品有什么备注信息可以写这里." rows="2" cols="5"></textarea>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="payment" class="woocommerce-checkout-payment">
                                            <ul class="wc_payment_methods payment_methods methods">
                                                <li class="wc_payment_method payment_method_cheque">
                                                    <input id="payment_method_cheque" type="radio" class="input-radio" name="payment_method" value="货到付款" checked="checked" data-order_button_text="">
                                                    <label for="payment_method_cheque">货到付款</label>
                                                ...
                                                <li class="wc_payment_method payment_method_cod">
                                                    <input id="payment_method_cod" type="radio" class="input-radio" name="payment_method" value="支付宝" data-order_button_text="">
