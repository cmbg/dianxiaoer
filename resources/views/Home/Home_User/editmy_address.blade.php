								...
								<div class="entry-content">
									<div class="woocommerce">
										...
										<div class="woocommerce-MyAccount-content">
											<form method="post" action="{{url('home/domy_address')}}">
											{{csrf_field()}}
												<h3>账单地址</h3>
												<p class="form-row form-row form-row-first validate-required" id="billing_first_name_field">
													...
													<input type="text" class="input-text " name="name" id="billing_first_name" placeholder="请填写收货人姓名" autocomplete="given-name" value="{{$address->name}}" />
												</p>
												<div class="clear"></div>
												<p class="form-row form-row form-row-last validate-required validate-phone" id="billing_phone_field">
													...
													<input type="tel" class="input-text " name="phone" id="billing_phone" placeholder="请填写收货人手机号" autocomplete="tel" value="{{$address->phone}}" />
												</p>
												<div class="clear"></div>
												...
												<p class="form-row form-row form-row-wide address-field validate-required" id="billing_address_1_field">
													...
													<input type="text" class="input-text " name="address" id="billing_address_1" placeholder="请填写收货地址" autocomplete="address-line1" value="{{$address->address}}" />
												</p>
